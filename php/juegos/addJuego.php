...
//  1. Crea una carpeta nueva en la que se guardarán los archivos del juego
//  2. Se crean las rutas de la miniatura, del juego, y de la demo y juego en caso de que tenga, y se guardan en la carpeta
//  3. Se registra el nuevo juego en la tabla "Juegos" con los datos especificados
//  4. Se solicita la id del nuevo juego, con el que se podrá guardar correctamente las imagenes secundarias y los genero del juego
//  5. Se registra el nuevo juego y la id del usuario activo en la tabla "JuegoPorDeveloper" 
//  6. Se registran los generos asociados al juego en la tabla "GeneroPorJuego" 
//  7. Se guardan las imagenes secundarias en la carpeta, y se registran las rutas de las imagenes en la tabla "ImagenesSecund"
//  8. Una vez terminado todo, redirige al usuario al index 
    session_start();
